@REM tcs-client launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM TCS_CLIENT_config.txt found in the TCS_CLIENT_HOME.
...
if "%TCS_CLIENT_HOME%"=="" (
  ...
  set "TCS_CLIENT_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%TCS_CLIENT_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\TCS_CLIENT_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running tcs-client.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !TCS_CLIENT_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
