@REM tcs-deploy launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM TCS_DEPLOY_config.txt found in the TCS_DEPLOY_HOME.
...
if "%TCS_DEPLOY_HOME%"=="" (
  ...
  set "TCS_DEPLOY_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%TCS_DEPLOY_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\TCS_DEPLOY_config.txt"
set CFG_OPTS=
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running tcs-deploy.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !TCS_DEPLOY_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
